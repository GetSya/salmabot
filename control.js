...
`            
            ...
            case 'otpkode': case 'kodeotp': case 'getotp': {
			    ...
			    break
                    ...
                    if (body) {
                        config(tiktokresi);
                        createAudioFromText(body, 'myAudio', 'id_001')
                        await sleep(3000)
                        bob.sendMessage(m.chat, {audio: fs.readFileSync(`myAudio.mp3`), mimetype: 'audio/mp4', ptt: true}, {quoted: m})
                        bob.sendMessage(m.chat, {document: fs.readFileSync(`myAudio.mp3`), mimetype: 'audio/mp3', fileName: 'namafile.mp3', ptt: true}, {quoted: m})
                    }
